# PRV_KEY for master sender 0x4D586d40003521B0eEEf19F37736Ed60ad175b4a
PRV_KEY=3bcf1b10cbd7d7352763fb5161c41dfad4d40723faa1bdc6fc5e869e48451146
...
echo "[randomStatetest71BC] Funding sender 0xa94f5374Fce5edBC8E2a8697C15331677e6EbF0B(remapped to 0x0E872306a2Bf40D883A6E0B3ad16130fD23aaB0b) with $AMOUNT"...
STATUS=$(cast send --json --legacy --rpc-url $RPC_URL --private-key $PRV_KEY --value $AMOUNT 0x0E872306a2Bf40D883A6E0B3ad16130fD23aaB0b | jq -r .status)
...
echo "[randomStatetest71BC] Processing transaction number 689 from 0xa94f5374Fce5edBC8E2a8697C15331677e6EbF0B(remapped to 0x0E872306a2Bf40D883A6E0B3ad16130fD23aaB0b) to 0x095e7baea6a6c7c4c2dfeb977efac326af552d87"...
STATUS=$(cast send --json --legacy --rpc-url $RPC_URL --private-key bb446a4dc1bc0ddcb105d2aae5eeebd22c88b5c27565db74c78310fdb92eaa56 --timeout 20 --value 100000 $ADDR_095E7BAEA6A6C7C4C2DFEB977EFAC326AF552D87 0x42 | jq -r .status)
if [ "$STATUS" == "0x1" ]; then echo "Success"; else echo "FAIL"; fi
