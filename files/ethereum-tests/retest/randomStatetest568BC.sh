# PRV_KEY for master sender 0x8b711c7Ba9CBb55eFb3Fdce6D987321400df67f2
PRV_KEY=a605dcebc424d1bcd6bb3c4a4833f9a66075aa20fac87de19131b3265e15fdb0
...
echo "[randomStatetest568BC] Funding sender 0xa94f5374Fce5edBC8E2a8697C15331677e6EbF0B(remapped to 0x414c38b74506eF7694026a72f5090Ca1b9a4736f) with $AMOUNT"...
STATUS=$(cast send -j --legacy --rpc-url $RPC_URL --private-key $PRV_KEY --value $AMOUNT 0x414c38b74506eF7694026a72f5090Ca1b9a4736f | jq -r .status)
...
echo "[randomStatetest568BC] Processing transaction number 603 from 0xa94f5374Fce5edBC8E2a8697C15331677e6EbF0B(remapped to 0x414c38b74506eF7694026a72f5090Ca1b9a4736f) to 0x095e7baea6a6c7c4c2dfeb977efac326af552d87"...
STATUS=$(cast send -j --legacy --rpc-url $RPC_URL --private-key 037bdd7656083856317d66949d70feed3b42f955e03d013775fc93651aa95d18 --timeout 20 --value 100000 $ADDR_095E7BAEA6A6C7C4C2DFEB977EFAC326AF552D87 0x42 | jq -r .status)
if [ "$STATUS" == "0x1" ]; then echo "Success"; else echo "FAIL"; fi
